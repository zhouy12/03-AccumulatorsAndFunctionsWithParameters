...
def digits_in_cube(n):
    ...
    """
    digits_cub_sum = sum_of_digits(math.pow(n, 3))
    return digits_cub_sum
    # ------------------------------------------------------------------
...
def fancy_sums_of_digits(n):
    ...
    sum_of_x_and_y = sum_of_digits(x**y)
